...
<sup>1,</sup>[Yu-Ho Chang](https://www.linkedin.com/in/yu-ho-chang-91398b223/) <sup>1</sup>[Chi-Hsi Kung](https://hankkung.github.io/website/),  <sup>2</sup>[Yi-Hsuan Tsai](https://sites.google.com/site/yihsuantsai/),  <sup>1</sup>[Yi-Ting Chen](https://sites.google.com/site/yitingchen0524)

<sup>1</sup>National Yang Ming Chiao Tung University,  <sup>2</sup>Atmanity Inc.

[[Project Page](https://hcis-lab.github.io/Action-slot-TPAMI_project_page/)]
...
**TACO**: [[link](https://drive.google.com/drive/folders/1mK--RbUUAenY3fFA1RlDgkIgOXmNFzaI)]
...
## 🚀 Training and Evaluation: Localization Model 

### Train & Evaluation of Localization
To train and evaluate the localization model, run [train_loc.sh](./scripts/train_loc.sh) and [eval_loc.sh](./scripts/eval_loc.sh). You Can also evaluate the pseudo masks with [eval_pseudo_mask.sh](./scripts/eval_pseudo_mask.sh). 

```
# training
python train_localization.py --attn_cp [/path/to/attn_source.pth] --cp [/path/to/recog_model.pth] \
        ...
        --ref --pseudo_mask --refine --attn_backbone [attn source model backbone] --backbone [recog model backbone] --decoder [localization decoder]
